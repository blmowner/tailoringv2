            ...
            <div class='row'>
               ...
               <div class='col-md-6'>
                  <div class='form-group'>
                  	...
                  	<div class='col-xs-8'>
						<input type='text' class='form-control' name='g_color' value='$rowGarment[g_color]' readonly />
                  	</div>
                  </div>
                </div>
                <div class='col-md-1'>
            ...
            <div class='row'>
               ...
               <div class='col-md-6'>
                  <div class='form-group'>
                  	...
                  	<div class='col-xs-8'>
                  		<input type='number' step='0.01' class='form-control' name='g_neck' value='$rowGarment[g_neck]' placeholder='Ukuran Keliling Leher' readonly />
                  	</div>
                  </div>
               </div>
               <div class='col-md-1'>
            ...
            <div class='row'>
               ...
               <div class='col-md-6'>
                  <div class='form-group'>
                  	...
                  	<div class='col-xs-8'>
                  		<input type='number' step='0.01' class='form-control' name='g_shoulder' value='$rowGarment[g_shoulder]' placeholder='Ukuran Lebar Bahu' readonly />
                  	</div>
                  </div>
               </div>
               <div class='col-md-1'>
		    ...
		    <div class='row'>
		       ...
		       <div class='col-md-6'>
                  <div class='form-group'>
                  	...
                  	<div class='col-xs-8'>
                  		<input type='number' step='0.01' class='form-control' name='g_bust' value='$rowGarment[g_bust]' placeholder='Ukuran Keliling Dada' readonly />
                  	</div>
                  </div>
               </div>
               <div class='col-md-1'>
		    ...
		    <div class='row'>
		       ...
		       <div class='col-md-6'>
                  <div class='form-group'>
                     ...
                     <div class='col-xs-8'>
                     	<input type='number' step='0.01' class='form-control' name='g_waist' value='$rowGarment[g_waist]' placeholder='Ukuran Keliling Pinggang' readonly />
                     </div>
                  </div>
               </div>
               <div class='col-md-1'>
		    ...
		    <div class='row'>
               ...
               <div class='col-md-6'>
                  <div class='form-group'>
                	 ...
                	 <div class='col-xs-8'>
                		<input type='number' step='0.01' class='form-control' name='g_hips' value='$rowGarment[g_hips]' placeholder='Ukuran Keliling Pinggul' readonly />
                	 </div>
                  </div>
               </div>
               <div class='col-md-1'>
            ...
            <div class='row'>
              ...
              <div class='col-md-6'>
                 <div class='form-group'>
                	...
                	<div class='col-xs-8'>
                		<input type='number' step='0.01' class='form-control' name='g_length' value='$rowGarment[g_length]' placeholder='Ukuran Labuh Baju' readonly />
                	</div>
                 </div>
               </div>
               <div class='col-md-1'>
            ...
            <div class='row'>
               ...
               <div class='col-md-6'>
                  <div class='form-group'>
                  	...
                  	<div class='col-xs-8'>
                  		<input type='number' step='0.01' class='form-control' name='g_arm_hole' value='$rowGarment[g_arm_hole]' placeholder='Ukuran Bukaan Tangan' readonly />
                  	</div>
                  </div>
               </div>
               <div class='col-md-1'>
			 ...
			 <div class='row'>
               ...
               <div class='col-md-6'>
                  <div class='form-group'>
                  	...
                  	<div class='col-xs-8'>
                  		<input type='number' step='0.01' class='form-control' name='labuh_seluar' value='$rowGarment[labuh_seluar]' placeholder='Labuh Seluar' readonly />
                  	</div>
                  </div>
               </div>
               <div class='col-md-1'>
			 ...
			 <div class='row'>
               ...
               <div class='col-md-6'>
                  <div class='form-group'>
                  	...
                  	<div class='col-xs-8'>
                  		<input type='number' step='0.01' class='form-control' name='labuh_kain' value='$rowGarment[labuh_kain]' placeholder='Labuh Kain' readonly />
                  	</div>
                  </div>
               </div>
               <div class='col-md-1'>
			 ...
			 <div class='row'>
               ...
               <div class='col-md-6'>
                  <div class='form-group'>
                  	...
                  	<div class='col-xs-8'>
                  		<input type='number' step='0.01' class='form-control' name='labuh_jubah' value='$rowGarment[labuh_jubah]' placeholder='Labuh Juba' readonly />
                  	</div>
                  </div>
               </div>
               <div class='col-md-1'>
			 ...
			 <div class='row'>
               ...
               <div class='col-md-6'>
                  <div class='form-group'>
                  	...
                  	<div class='col-xs-8'>
                  		<input type='number' step='0.01' class='form-control' name='keliling_cawat' value='$rowGarment[keliling_cawat]' placeholder='Keliling Cawat' readonly />
                  	</div>
                  </div>
               </div>
               <div class='col-md-1'>
			 ...
			 <div class='row'>
               ...
               <div class='col-md-6'>
                  <div class='form-group'>
                  	...
                  	<div class='col-xs-8'>
                  		<input type='number' step='0.01' class='form-control' name='keliling_peha' value='$rowGarment[keliling_peha]' placeholder='Keliling Peha' readonly />
                  	</div>
                  </div>
               </div>
               <div class='col-md-1'>
			 ...
			 <div class='row'>
               ...
               <div class='col-md-6'>
                  <div class='form-group'>
                  	...
                  	<div class='col-xs-8'>
                  		<input type='number' step='0.01' class='form-control' name='panjang_cawat' value='$rowGarment[panjang_cawat]' placeholder='Panjang Cawat' readonly />
                  	</div>
                  </div>
               </div>
               <div class='col-md-1'>
			 ...
			 <div class='row'>
               ...
               <div class='col-md-6'>
                  <div class='form-group'>
                  	...
                  	<div class='col-xs-8'>
                  		<input type='number' step='0.01' class='form-control' name='panjang_tgn' value='$rowGarment[panjang_tgn]' placeholder='Panjang Tangan' readonly />
                  	</div>
                  </div>
               </div>
               <div class='col-md-1'>
            ...
            <div class='row'>
               ...
               <div class='col-md-6'>
		          <div class='form-group'>
		          	...
		          	<div class='col-xs-8'>
		          		<textarea class='form-control' name='g_others' placeholder='masukkan maklumat tambahan mengenai pakaian anda' style='height:100px;' readonly>$rowGarment[g_others]</textarea>
		          	</div>
		          </div>
		       </div>
		       <div class='col-md-1'>
		       ...
		       <div class='col-md-6'>
                  <div class='form-group'>
                  	<div class='col-xs-9 col-xs-offset-3'>
                  		<a href='manage_order.php' class='btn btn-default'>Kembali</a>
                  	</div>
                  </div> 
               </div>
               <div class='col-md-1'>
